// src/pages/chat/components/chat-container/components/message-container/index.jsx
...
const MessageContainer = () => {
    ...
    const renderDMMessage = (message) => {
        ...
        return (
            ...
            >
                <div
                    className={`max-w-[85%] xs:max-w-[80%] sm:max-w-[75%] md:max-w-[70%] rounded-lg p-3 ${
                        isSender
    ...
    return (
        <div className="flex-1 overflow-y-auto scrollbar-hidden p-4 px-4 sm:px-6 md:px-8 w-full">
            {renderMessages()}
            <div ref={scrollRef} />
        </div>
    );
